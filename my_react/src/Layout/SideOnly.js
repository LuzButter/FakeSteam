...
const DefaultLayout = ({ children, }) => {
    ...
    return (
        <>
            <SiderLayout>
                <Sider className={'gap-3'}  >
                    <div className='flex align-items-center justify-content-center' style={{ width: 'auto' }} >
                ...
                <Content style={{ padding: '16px 16px', boxShadow: 'inset 4px 0px 15px -3px rgba(0,0,0,0.1)' }} >
                    {children}
                </Content>
            </SiderLayout>
        </>
